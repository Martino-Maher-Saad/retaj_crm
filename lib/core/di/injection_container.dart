...
import '../../data/services/form_field_service.dart';
...
import '../../features/admin_users/cubit/form_field_cubit.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(() => FormFieldCubit(sl()));
  ...
  sl.registerLazySingleton(() => TasksCubit(sl(), sl()));
  sl.registerFactory(() => LeadTasksCubit(sl()));
  sl.registerFactory(() => PropertyTasksCubit(sl(), sl()));
  ...
  sl.registerLazySingleton(() => FormFieldRepository(sl()));
  ...
  sl.registerLazySingleton(() => TaskService(Supabase.instance.client));
  sl.registerLazySingleton(() => FormFieldService(Supabase.instance.client));
  sl.registerLazySingleton(() => RealtimeSyncService());
  sl.registerLazySingleton<StaticDataManager>(() => StaticDataManagerImpl(sl(), sl(), sl()));
}
